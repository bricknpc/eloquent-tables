...
class DateTimeFormatterTest extends TestCase
{
    ...
    {
        $formatter = new DateTimeFormatter('en_US', 'Asia/Tokyo');
    ...
    {
        $formatter = new DateTimeFormatter('en_US', new \DateTimeZone('Asia/Tokyo'));
    ...
    {
        $formatter = new DateTimeFormatter('en_US', 'Not/AZone');
    ...
    {
        $formatter = new DateTimeFormatter('en_US', 'UTC');
    ...
    {
        $this->assertNotSame('', (string) new DateTimeFormatter('en_US', 'UTC')->format(Carbon::parse('2026-08-17 12:00:00')));
    }
}
