...
class WhenTest extends TestCase
{
    ...
    public function test_check_passes_context_to_closure(): void
    {
        ...
        $when = new When(static function (ActionContext $ctx) use (&$contextPassed): bool {
            $contextPassed = $ctx;
    ...
    public function test_check_is_evaluated_on_every_call(): void
    {
        ...
        $when = new When(static function (ActionContext $context) use (&$callCount): bool {
            ++$callCount;
    ...
    public function test_check_can_return_a_different_result_per_call(): void
    {
        ...
        $when = new When(static function (ActionContext $context) use (&$allowed): bool {
            return $allowed;
        });
